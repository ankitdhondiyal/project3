	...
	<div>
		...
		<form action="<%=ORSView.LOGIN_CTL%>" method="post">
			...
			<div class="row log1">
				...
				<div class="col-md-4">
					<div class="card input-group-addon grad	"> <!--login mai dabbe ke liye card and card body 2 class use ki h-->
						<div class="card-body">
							...
							<div>
								...
								<H4 align="center">
									...
									%>
									<div class="alert alert-success alert-dismissible">  <!-- susscess msg box ke liye. &times se cross ka sign aara hai -->
							...
							<span class="pl-sm-5"><b>Email Id</b> <span 
								style="color: red;">*</span></span> </br> <!-- padding left small 5 -->
